...
trigger = new Trigger(100,150);
slingshot = new Slingshot(trigger.object,{x:100,y:120})
...
function mouseDragged(){
    Matter.Body.setPosition(trigger.object,{x:mouseX,y:mouseY})
}
...
function keyPressed(){
    if(keyCode===32){
        slingshot.attach(trigger.object)
    }
}